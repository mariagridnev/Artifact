...
/* =============================================================================
   Video links for the homepage and work panels
   ========================================================================== */		
...
/* =============================================================================
   ...
   _processData:function(dataItem,self) {
	   ...
	   if(self.counter < maxTiles) {
			...
			self.itemSource += artifact.substitute(self.itemTemplate,{ imgSource:dataItem.thumbnails.thumbnail[1]._content,
																		videoId:dataItem.id,
   ...
   writePage:function(){
	   ...
	   $('#work .panels').prepend('<div class="flexslider"><ul class="slides"><div class="loading"></div></ul></div>');
		...
		$.getJSON("http://www.artifactdesign.com/vimeo/index.php?album_id=" + self.albumID,function(data) {
			...
			$(data.videos.video).each(function(){self._processData(this);});
